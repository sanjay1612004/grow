...
function StockCard({ logo, name, price, change, changeVal, up, bookmark }) {
  ...
  return (
    <div
      className="relative flex flex-col cursor-pointer hover:shadow-sm transition-shadow justify-between overflow-hidden"
      style={{
        width: "188px",
        height: "182px",
        background: "#FFFFFF",
...
function NewsCard({ logo, name, change, up, headline, time }) {
  const color = up ? "text-[#00b386]" : "text-[#eb5757]";
  return (
    <div className="flex-1 border border-gray-100 rounded-xl p-5 bg-white cursor-pointer hover:shadow-sm transition-shadow flex flex-col justify-between min-w-0">
      <div>
...
// ── trading screen card ──────────────────────────────────────────────────────
function TradingCard({ title, label, type }) {
  const isBullish = type === "Bullish";
  const bg = isBullish ? "bg-[#e6f7f3] text-[#00b386]" : "bg-[#fdf2f2] text-[#eb5757]";

  return (
    <div className="flex items-center justify-between px-4 py-3.5 border-b border-gray-100 hover:bg-gray-50 cursor-pointer transition-colors">
      ...
      <div className="w-14 h-8 flex-shrink-0 ml-2">
        <svg width="56" height="32" viewBox="0 0 56 32" className="overflow-visible">
          {isBullish ? (
            <path d="M0 24 Q14 22, 28 14 T56 4" stroke="#00b386" strokeWidth="1.5" fill="none" strokeLinecap="round" />
          ) : (
            <path d="M0 6 Q14 8, 28 16 T56 26" stroke="#eb5757" strokeWidth="1.5" fill="none" strokeLinecap="round" />
          )}
        </svg>
      </div>
    </div>
...
export default function Explore() {
  ...
  const tradingScreens = [
    { title: "High momentum stocks", label: "Bullish", type: "Bullish" },
    { title: "Volume shockers", label: "Bullish", type: "Bullish" },
    { title: "52-week high breakouts", label: "Bullish", type: "Bullish" },
    { title: "Bearish MACD crossover", label: "Bearish", type: "Bearish" },
  ];
      ...
      <header className="bg-white border-b border-gray-100 sticky top-0 z-40">
        <div className="max-w-[1400px] mx-auto px-6 h-14 flex items-center gap-6">
          ...
          <div className="flex-1 max-w-xs ml-auto">
            <div className="flex items-center bg-gray-50 border border-gray-200 rounded-lg px-3 h-9 gap-2 focus-within:border-gray-400 focus-within:bg-white transition-colors">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-8">
            ...
            <section>
              ...
              <div className="grid grid-cols-4 gap-3">
                {intradayStocks.map(s => <StockCard key={s.name} {...s} />)}
              </div>
              <button className="mt-3 text-sm text-[#00b386] font-medium hover:underline flex items-center gap-1">
            ...
            <section>
              ...
              <div className="grid grid-cols-4 gap-3">
                {etfsBought.map(s => <StockCard key={s.name + "-groww"} {...s} />)}
              </div>
              <button className="mt-3 text-sm text-[#00b386] font-medium hover:underline flex items-center gap-1">
                See all ETFs <svg width="12" height="12" viewBox="0 0 24 24" fill="none"><path d="M9 18l6-6-6-6" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
              </button>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-4">
                {newsStocks.map(s => <NewsCard key={s.name} {...s} />)}
              </div>
              <button className="mt-4 text-sm text-[#00b386] font-medium hover:underline flex items-center gap-1">
                See more news
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
          ...
          <aside className="w-120 flex-shrink-0 space-y-4 h-fit">
            ...
            {/* Products & Tools */}
            <div className="bg-white border border-gray-100 rounded-xl overflow-hidden">
              <h3 className="text-base font-semibold text-gray-900 px-4 pt-4 pb-2">Products & Tools</h3>
              {products.map((p, i) => (
            ...
            {/* Trading Screens */}
            <div className="bg-white border border-gray-100 rounded-xl overflow-hidden sticky top-24 shadow-sm">
              <h3 className="text-base font-semibold text-gray-900 px-4 pt-4 pb-2">Trading screens</h3>
