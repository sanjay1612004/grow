...
{userPic && <img src={userPic} alt="" width={28} height={28} className='rounded-2xl'/>}
      ...
      <div className="bg-white min-h-screen px-8 py-7 max-w-[1280px] mx-auto">
        ...
        <div className="flex gap-2 items-center mb-6 flex-wrap">
          ...
          <FilterChip label="Price change >1%" active onClick={() => setShowPanel(true)} />
          <FilterChip label="52W Performance" onClick={() => setShowPanel(true)} />
          <FilterChip label="RSI" onClick={() => setShowPanel(true)} />
          <FilterChip label="MACD" onClick={() => setShowPanel(true)} />
